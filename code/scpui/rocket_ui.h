 ...
 *
 * @details This translates all drawing operations by the specified offset and transforms input events by the same offset
 * to bring them back into the same frame of reference for libRocket.
 *
