...
class RocketSystemInterface : public Rocket::Core::SystemInterface {
 public:
	...
	/**
	 * @details Since the FSO file opening implementation already takes care of locating a specific file, this implementation
	 * simply returns the path that was specified in the document without altering it.
	 *
